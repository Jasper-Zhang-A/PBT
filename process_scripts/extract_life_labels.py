...
dataset_root_path = '/data/trf/python_works/PBT_BatteryLife/dataset/'
...
label_root_path = os.path.join(dataset_root_path, 'Life labels')
os.makedirs(label_root_path, exist_ok=True)
print(f'Labels are saved in {label_root_path}/{dataset_name}_labels.json')
if dataset_name == 'UL_PUR':
    with open(f'{label_root_path}/UL-PUR_labels.json', 'w') as f:
        json.dump(name_lables, f)
elif dataset_name == 'ZNcoin' or dataset_name == 'ZN-coin':
    with open(f'{label_root_path}/ZN-coin_labels.json', 'w') as f:
        json.dump(name_lables, f)
elif dataset_name == 'NAion':
    with open(f'{label_root_path}/NA-ion_labels.json', 'w') as f:
        json.dump(name_lables, f)
else:
    with open(f'{label_root_path}/{dataset_name}_labels.json', 'w') as f:
        json.dump(name_lables, f)
